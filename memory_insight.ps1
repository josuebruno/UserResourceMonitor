...
$pythonScript = "C:\Users\Teste\Documents\resourcemonitor\UserResourceMonitor\user_memory_inspector.py"
$scriptArgs = @("-u", $username, "-MemoryUsage")
...
$userMemoryUsage = & "C:\Python312\python.exe" $pythonScript $scriptArgs
...
& "C:\Python312\python.exe" $pythonScript $scriptArgs
